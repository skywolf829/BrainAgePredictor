...
features_1 = sc_X.transform(features_1)
features_2 = sc_X.transform(features_2)
features_3 = sc_X.transform(features_3)
...
average_age_diff_1 = calcAverageDiff(y_pred1, ages_1)
average_age_diff_2 = calcAverageDiff(y_pred2, ages_2)
average_age_diff_3 = calcAverageDiff(y_pred3, ages_3)
...
#print("break")
#printWithLines(y_predAll - ages_all)